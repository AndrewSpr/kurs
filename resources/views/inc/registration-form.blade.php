<div class="authentication">
    <div class="box">
        ...
        <form action="{{ route('user.registration') }}" class="authentication__auth-form" method="POST">
            <div class="auth__box">
                @csrf
                ...
                <button class="button" type="submit" name="sendMe" value="1">Зарегистрироваться</button>
            </div>
        </form>
    </div>
</div>
